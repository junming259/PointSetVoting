...
idx = '15'
folder = 'completion3D_benchmark_model/eval_sample_results'
...
# generated_latent_pc
filename = '../completion3D/checkpoint/{}/generated_latent_pc_{}.npy'.format(folder, idx)
points0 = np.load(filename)
points0 = points0.reshape(-1, 3)


# generated_pc
filename = '../completion3D/checkpoint/{}/generated_pc_{}.npy'.format(folder, idx)
...
filename = '../completion3D/checkpoint/{}/pos_{}.npy'.format(folder, idx)
...
# observed points
filename = '../completion3D/checkpoint/{}/pos_observed_{}.npy'.format(folder, idx)
...
# contribution points
filename = '../completion3D/checkpoint/{}/contribution_pc_{}.npy'.format(folder, idx)
