...
class completion3D_class(InMemoryDataset):
    ...
    def process_filenames(self, filenames, split_in_loop):
        ...
        for name in filenames:
            ...
            # if the input split is 'val', we are given partial point clouds (pos) in the validation 
            # set to infer the complete point clouds. Then the chamfer loss between our prediction
            # and the ground truth (y) in the validation set will be computed.
